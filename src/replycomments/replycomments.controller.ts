...
export class ReplycommentsController {
    ...
    return await this.replycommentsService.updateReplyComment(replycommentUpdateRequestDto);
    }
    ...
    return await this.replycommentsService.deleteReplyComment(replycommentDeleteRequestDto);
    }
    ...
    const response = {
      replys: await this.replycommentsService.getAllReplyComment(replycommentGetRequestDto)
    };
